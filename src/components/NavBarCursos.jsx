...
import '../styles/menuBarCursos.css';
        ...
        <nav className={`nav-container-menu ${isScrolled ? 'scrolled-menu' : ''}`}>
            ...
            <li className="nav-item-menu">
                ...
                <li className="nav-item-menu has-submenu">
                    ...
                    <ul className="submenu">
                        <li><Link to="/nosotros" className="submenu-link">Periodismo</Link></li>
                        <li><Link to="/nosotros" className="submenu-link">Audiovisual</Link></li>
                        <li><Link to="/nosotros" className="submenu-link">SocialMedia</Link></li>
                        <li><Link to="/nosotros" className="submenu-link">Otros</Link></li>
                    </ul>
                </li>
            </ul>
