  ...
  return (
    <nav className={`nav-container-menu ${isScrolled ? 'scrolled-menu' : ''}`}>
      ...
      <ul className="nav-right-menu desktop-menu">
        ...
        <li className="nav-item-menu">
          <Link to="/contacto" className="nav-link-menu">Contáctanos</Link>
        </li>
        <li className="nav-item-menu">
        ...
        <ul className="mobile-menu-list">
          ...
          <li className="mobile-menu-item">
            ...
            <ul className="mobile-submenu">
              <li onClick={closeMobileMenu}><Link to="/nosotros#instructores">Instructores</Link></li>
              <li onClick={closeMobileMenu}><Link to="/nosotros#certificados">Certificados</Link></li>
              <li onClick={closeMobileMenu}><Link to="/nosotros#galeria">Galería</Link></li>
            </ul>
          </li>
          <li className="mobile-menu-item">
            <span>Cursos</span>
            <ul className="mobile-submenu">
              <li onClick={closeMobileMenu}><Link to="/cursos#periodismo">Periodismo</Link></li>
              <li onClick={closeMobileMenu}><Link to="/cursos#audiovisual">Audiovisual</Link></li>
              <li onClick={closeMobileMenu}><Link to="/cursos#socialMedia">SocialMedia</Link></li>
              <li onClick={closeMobileMenu}><Link to="/cursos#otros">Otros</Link></li>
            </ul>
          </li>
          <li className="mobile-menu-item" onClick={closeMobileMenu}>
